...
let lastContext;
export function getLastContext(identifier) {
 ...
 */
export function wrapArgs(args, context) {
    return args.map((arg) => {
        if (typeof arg === 'function') {
            return wrap(arg, context);
        }
        return arg;
    });
}
 ...
 */
export function wrapInstanceMethods(instance) {
 ...
 */
export function enrichError(error, instance) {
 ...
 */
export function getErrorInstance(error) {
    if (error == null || typeof error !== 'object') {
        return undefined;
    }
    return error[SymbolDiveInstance];
}
/**
 ...
 */
export function runWithInstance(instance, fn) {
    const previousContext = lastContext;
    lastContext = instance;
    try {
        return fn();
